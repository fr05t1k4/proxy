...
class AngryCurl extends RollingCurl {
        ...
        public static $alive_proxy_list_info = array();
        /**
        ...
        public static function callback_proxy_check($response, $info, $request) {
                static $rid = 0;
                $rid++;
                self::$alive_proxy_list_info[] = array('info' => $info, 'request' => $request);
        ...
        public function call_back_func($response, $info, $request) {
                //var_dump($response);
                var_dump($info['connect_time']);
                var_dump($request->options[10004]);
        }
