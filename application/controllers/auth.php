...
class Auth extends CI_Controller {
	...
	function index()
	{
		...
		else
		{
			...
			$this->load->view('header-view', $this->data);
			$this->load->view('auth/index', $this->data);
			$this->load->view('footer-view', $this->data);
		}
	}
	...
	function change_password()
	{
		...
		$this->form_validation->set_rules('new_confirm', 'Подтвердите новый пароль', 'required');
...
//		}
		...
		$this->form_validation->set_rules('password_confirm', 'Подтверждения пароля', 'required');
